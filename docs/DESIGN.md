...
| `gold-400` | `#FFDA6B` | 밝은 노랑 (hover, 라이트 틴트) |
| `gold-500` | `#FFC42E` | 기준 브랜드색 — CTA 채움, 활성 상태, 포커스 링 |
| `gold-600` | `#E9A600` | 진한 노랑 (active, 보더) |
| `gold-ink` | `#241A00` | 금색 '채움' 위에 올리는 글자색 (대비 10.8:1) |
| `gold-text` | `#8A6100` 라이트 / `#FFC42E` 다크 | 배경 위 금색 '글자·아이콘' 전용 (흰 배경 대비 5.5:1) |
...
- 밝은 노랑(`gold-500`)을 흰 배경 위 **글자·아이콘 색**으로 쓰지 않는다 (대비 1.7:1) — `text-gold-text`를 쓴다.
