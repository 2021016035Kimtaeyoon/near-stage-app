    ...
    case 'stage':
      return (
        <svg viewBox="0 0 120 88" className="h-[88px] w-[120px]">
          ...
          <circle cx="60" cy="34" r="7" stroke="rgb(var(--color-gold-text))" strokeWidth="1.8" fill="none" />
          <path d="M60 41v10M53 51h14" stroke="rgb(var(--color-gold-text))" strokeWidth="1.8" strokeLinecap="round" />
        </svg>
      )
    case 'search':
      return (
        <svg viewBox="0 0 120 88" className="h-[88px] w-[120px]">
          ...
          <circle cx="54" cy="40" r="6" stroke="rgb(var(--color-gold-text))" strokeWidth="1.8" fill="none" />
        </svg>
      )
    case 'ticket':
      return (
        <svg viewBox="0 0 120 88" className="h-[88px] w-[120px]">
          ...
          <path d="M36 44h14M36 52h10" stroke="rgb(var(--color-gold-text))" strokeWidth="1.8" strokeLinecap="round" />
        </svg>
      )
    case 'chat':
      return (
        <svg viewBox="0 0 120 88" className="h-[88px] w-[120px]">
          ...
          <path d="M34 34h26M34 42h18" stroke="rgb(var(--color-gold-text))" strokeWidth="1.8" strokeLinecap="round" />
        </svg>
      )
    case 'chart':
      return (
        <svg viewBox="0 0 120 88" className="h-[88px] w-[120px]">
          ...
          <rect x="72" y="30" width="10" height="38" stroke="rgb(var(--color-gold-text))" strokeWidth="1.8" fill="none" />
        </svg>
      )
  }
}
