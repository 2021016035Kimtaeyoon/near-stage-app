...
/**
 * 공연 60건 = 우리 무대(own) 48 + 등록 공연(kopis) 12.
 * 기준 시각(DEMO_NOW) 전후 3일(2026-09-02 ~ 09-08)에 분포하며,
 * "오늘 밤"(09-05 저녁)에 가장 많이 몰려 있습니다.
 */
...
const OWN: OwnSpec[] = [
  ...
  // ── 추가 공연 26건 — 목록이 비어 보이지 않도록 오늘 밤·주말에 집중 배치 ──
  {
    id: 's23',
    venueId: 'v2',
    performerId: 'p3',
    ...
    price: 8000,
    tags: ['어쿠스틱', '착석'],
    description: '연남 살롱 드 밤의 금요일 어쿠스틱 세션. 28석 소규모입니다.',
  },
  {
    id: 's24',
    venueId: 'v9',
    ...
    hh: 22,
    mm: 0,
    title: '언더그라운드 나이트 vol.12',
    price: 12000,
    tags: ['스탠딩', '심야'],
    description: '상수 언더그라운드의 금요 심야 DJ 셋. 새벽 2시까지 이어집니다.',
  },
  {
    id: 's25',
    venueId: 'v6',
    ...
    price: 0,
    tags: ['무료', '식사 별도'],
    description: '도시밥상에서 저녁 시간에 흐르는 라이브. 식사하며 편하게 들으세요.',
  },
  {
    id: 's26',
    venueId: 'v13',
    ...
    price: 15000,
    tags: ['스탠딩', '밴드'],
    description: '홍대 스테이지Q의 금요 밴드 라이브. 앙코르 포함 90분.',
  },
  {
    id: 's27',
    venueId: 'v11',
    ...
    price: 6000,
    tags: ['낭독', '착석'],
    description: '상수 스튜디오 파랑에서 열리는 낭독극. 공연 후 관객과의 대화가 있습니다.',
  },
  {
    id: 's28',
    venueId: 'v16',
    ...
    price: 0,
    tags: ['무료', '오픈마이크'],
    description: '성수 바 브릭의 금요 오픈마이크. 누구나 5분씩 무대에 설 수 있어요.',
  },
  {
    id: 's29',
    venueId: 'v10',
    ...
    price: 7000,
    tags: ['어쿠스틱', '음료 포함'],
    description: '합정 카페 릴레이의 금요 어쿠스틱. 음료 한 잔이 포함됩니다.',
  },
  {
    id: 's30',
    venueId: 'v5',
    ...
    price: 12000,
    tags: ['연극', '착석'],
    description: '연남 소극장 무릎의 금요 정기공연. 70분 단막극입니다.',
  },
  {
    id: 's31',
    venueId: 'v8',
    ...
    price: 10000,
    tags: ['스탠딩', '심야'],
    description: '연남 라운지 909의 금요 솔로파티. 혼자 와도 어색하지 않습니다.',
  },
  {
    id: 's32',
    venueId: 'v3',
    ...
    price: 9000,
    tags: ['국악', '착석'],
    description: '경의선책거리 스튜디오의 해금 연주. 야외 데크에서 진행됩니다.',
  },
  {
    id: 's33',
    venueId: 'v15',
    ...
    price: 14000,
    tags: ['밴드', '스탠딩'],
    description: '성수 창고 스페이스45의 대형 편성 무대. 8인조 사운드입니다.',
  },
  {
    id: 's34',
    venueId: 'v7',
    ...
    price: 5000,
    tags: ['스탠드업', '착석'],
    description: '카페 마당의 늦은 밤 스탠드업. 60분 단독 무대입니다.',
  },
  {
    id: 's35',
    venueId: 'v1',
    ...
    price: 0,
    tags: ['무료', '어쿠스틱'],
    description: '카페 온화의 토요 정기 어쿠스틱. 커피 한 잔이면 입장입니다.',
  },
  {
    id: 's36',
    venueId: 'v4',
    ...
    price: 10000,
    tags: ['맥주 1잔 포함', '스탠딩'],
    description: '브루잉 연남의 토요 라이브. 하우스 에일이 포함됩니다.',
  },
  {
    id: 's37',
    venueId: 'v13',
    ...
    price: 15000,
    tags: ['밴드', '스탠딩'],
    description: '홍대 스테이지Q 토요 헤드라이너. 앙코르 포함 100분.',
  },
  {
    id: 's38',
    venueId: 'v2',
    ...
    price: 13000,
    tags: ['마술', '착석'],
    description: '연남 살롱 드 밤의 무대 마술. 좌석이 가까워 트릭이 잘 보입니다.',
  },
  {
    id: 's39',
    venueId: 'v12',
    ...
    price: 8000,
    tags: ['토론', '관객 참여'],
    description: '합정 다이닝 온에서 열리는 찬반 토론. 관객 투표로 승부가 갈립니다.',
  },
  {
    id: 's40',
    venueId: 'v9',
    ...
    price: 12000,
    tags: ['밴드', '심야'],
    description: '상수 언더그라운드의 토요 심야 밴드 셋.',
  },
  {
    id: 's41',
    venueId: 'v7',
    ...
    price: 0,
    tags: ['무료', '낮 공연'],
    description: '카페 마당의 일요일 낮 공연. 아이와 함께 와도 좋아요.',
  },
  {
    id: 's42',
    venueId: 'v5',
    ...
    price: 7000,
    tags: ['낭독', '착석'],
    description: '연남 소극장 무릎의 일요 낭독. 공연 후 차 한 잔이 제공됩니다.',
  },
  {
    id: 's43',
    venueId: 'v10',
    ...
    price: 9000,
    tags: ['클로즈업 매직', '음료 포함'],
    description: '합정 카페 릴레이의 일요 테이블 매직.',
  },
  {
    id: 's44',
    venueId: 'v15',
    ...
    price: 11000,
    tags: ['DJ', '스탠딩'],
    description: '성수 창고 스페이스45의 일요 심야 셋.',
  },
  {
    id: 's45',
    venueId: 'v1',
    ...
    price: 0,
    tags: ['무료', '오픈마이크'],
    description: '카페 온화의 월요 오픈마이크. 첫 무대도 환영합니다.',
  },
  {
    id: 's46',
    venueId: 'v6',
    ...
    price: 6000,
    tags: ['어쿠스틱', '식사 별도'],
    description: '도시밥상의 월요 라이브. 저녁 식사와 함께 즐기세요.',
  },
  {
    id: 's47',
    venueId: 'v16',
  ...
  },
  {
    ...
    price: 9000,
    tags: ['국악', '착석'],
    description: '상수 스튜디오 파랑의 월요 해금 정기 연주.',
  },
]
